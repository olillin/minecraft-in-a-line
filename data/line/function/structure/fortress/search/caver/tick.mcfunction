...
execute positioned ~1 ~ ~ unless block ~ ~ ~ air unless entity @e[type=marker,distance=..0.5,tag=line.fortress_search] run function line:structure/fortress/search/caver/summon
execute positioned ~-1 ~ ~ unless block ~ ~ ~ air unless entity @e[type=marker,distance=..0.5,tag=line.fortress_search] run function line:structure/fortress/search/caver/summon
execute positioned ~ ~1 ~ unless block ~ ~ ~ air unless entity @e[type=marker,distance=..0.5,tag=line.fortress_search] run function line:structure/fortress/search/caver/summon
execute positioned ~ ~-1 ~ unless block ~ ~ ~ air unless entity @e[type=marker,distance=..0.5,tag=line.fortress_search] run function line:structure/fortress/search/caver/summon
execute positioned ~ ~ ~1 unless block ~ ~ ~ air unless entity @e[type=marker,distance=..0.5,tag=line.fortress_search] run function line:structure/fortress/search/caver/summon
