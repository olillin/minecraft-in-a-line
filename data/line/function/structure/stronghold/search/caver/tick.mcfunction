...
execute positioned ~1 ~ ~ unless block ~ ~ ~ air unless entity @e[type=marker,distance=..0.5,tag=line.stronghold_search] run function line:structure/stronghold/search/caver/summon
execute positioned ~-1 ~ ~ unless block ~ ~ ~ air unless entity @e[type=marker,distance=..0.5,tag=line.stronghold_search] run function line:structure/stronghold/search/caver/summon
execute positioned ~ ~1 ~ unless block ~ ~ ~ air unless entity @e[type=marker,distance=..0.5,tag=line.stronghold_search] run function line:structure/stronghold/search/caver/summon
execute positioned ~ ~-1 ~ unless block ~ ~ ~ air unless entity @e[type=marker,distance=..0.5,tag=line.stronghold_search] run function line:structure/stronghold/search/caver/summon
execute positioned ~ ~ ~1 unless block ~ ~ ~ air unless entity @e[type=marker,distance=..0.5,tag=line.stronghold_search] run function line:structure/stronghold/search/caver/summon
