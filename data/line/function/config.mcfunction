...
tellraw @s {"text": " 1: ", "color": "aqua", "extra": [{"text": "Teleport player towards", "underlined": true}], "clickEvent": {"action": "run_command", "value": "/data modify storage line:config mode set value 1"}}
